          ...
          ListView(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    EntryFieldR(locale.vehicleType, "Hatchback", false),
                    EntryFieldR(
                        locale.vehicleName, "Mahindra Thar", false),
                    EntryFieldR(
                        locale.vehicleReg, "CF 25 MA 5214", false),
                    EntryFieldR(
                        '${locale.pricePerSeat} \$', "6", false),
                  ],
                ),
              ),
              Divider(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    EntryFieldR(
                        'Facilities (i.e AC, Extra Luggage, etc)', "No", false),
                    EntryFieldR(
                        'Instructions (No Smoking, pets)', "No", false),
                    SizedBox(
                      height: 20,
                    ),
                  ],
          ...
          Padding(
            ...
            child: GestureDetector(
                ...
                child: Container(
                    height: 55,
                    child: FadedScaleAnimation(
                      child: ColorButton(locale.update),
                      scaleDuration: const Duration(milliseconds: 600),
                    ))),
          )
        ],
