...
import 'package:order/screens/home/myTrips/poolTakerAcceptedOffer.dart';
...
class _PoolTakerRequestScreenState extends State<PoolTakerRequestScreen> {
  ...
  Future<dynamic> buildShowModalBottomSheet(
      ThemeData theme, BuildContext context, int index) {
    return showModalBottomSheet(
      ...
      builder: (context) => Column(
        ...
        children: [
          ...
          SizedBox(height: 30),
          buildColumn(theme, AppLocalizations.of(context)?.hobby ?? '',
              AppLocalizations.of(context)?.hobbyDetail ?? ''),
          SizedBox(height: 28),
          buildColumn(theme, AppLocalizations.of(context)?.bio ?? '',
              AppLocalizations.of(context)?.bioDetail ?? ''),
          SizedBox(height: 32),
        ],
      ),
    );
