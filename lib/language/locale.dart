...
class AppLocalizations {
  ...
  String? get setPricePerSeat {
    return _localizedValues[locale.languageCode]!['setPricePerSeat'];
  }

  String? get poolersOn {
    return _localizedValues[locale.languageCode]!['poolersOn'];
  }
  ...
  String? get hobby {
    return _localizedValues[locale.languageCode]!['hobby'];
  }

  String? get hobbyDetail {
    return _localizedValues[locale.languageCode]!['hobbyDetail'];
  }

  String? get bioDetail {
    return _localizedValues[locale.languageCode]!['bioDetail'];
  }

  String? get offering {
    return _localizedValues[locale.languageCode]!['offering'];
  }

  String? get finding {
    return _localizedValues[locale.languageCode]!['finding'];
  }
  ...
  String? get passengers {
    return _localizedValues[locale.languageCode]!['passengers'];
  }
  ...
  String? get requestRide {
    return _localizedValues[locale.languageCode]!['requestRide'];
  }

  String? get tripRoadmap {
    return _localizedValues[locale.languageCode]!['tripRoadmap'];
  }
  ...
  String? get endRide {
    return _localizedValues[locale.languageCode]!['endRide'];
  }

  String? get poolTakerRequest {
    return _localizedValues[locale.languageCode]!['poolTakerRequest'];
  }

  String? get decline {
    return _localizedValues[locale.languageCode]!['decline'];
  }
  ...
  String? get pricePerSeat {
    return _localizedValues[locale.languageCode]!['pricePerSeat'];
  }
  ...
  String? get addIssueFeedback {
    return _localizedValues[locale.languageCode]!['addIssueFeedback'];
  }
}
